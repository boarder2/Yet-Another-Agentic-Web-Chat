...
| `test-map-nearby`           | Calls `search_places` for deterministic nearby cafes, places the returned map, then answers with a numbered cited summary.                                                                   |
...
| `test-map-route`            | Calls `get_route` for a deterministic named driving route, places the map, then answers with a numbered route summary.                                                                       |
