    ...
    <div className="flex flex-col pt-4">
      <div className="flex items-center justify-between px-1 mb-6">
        <div className="flex items-center gap-3">
          <CalendarClock />
          <h2 className="text-3xl font-medium">Scheduled Tasks</h2>
        </div>
        <div className="flex items-center gap-2">
          <Link
            href="/scheduled-tasks/manage"
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-surface-2 hover:bg-surface-2/80 text-sm transition duration-200"
          >
            <Settings2 size={14} />
            Manage tasks
          </Link>
