...
| ------------------------------------ | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| **Web Search** (`webSearch`)         | Research current information across the internet                                    | Web, URL, image, PDF, video-transcript, deep-research, chart, artifact, history, skill, mapping when enabled, and other configured tools    |
