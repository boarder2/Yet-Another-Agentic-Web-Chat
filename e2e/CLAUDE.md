...
| `test-reasoning`         | Answers immediately with fixed text and advertises deterministic native-effort levels (`off`, `low`, `medium`, `high`) for capability/persistence coverage.                                  |
