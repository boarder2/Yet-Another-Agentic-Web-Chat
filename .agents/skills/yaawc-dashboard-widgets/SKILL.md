...
description: Dashboard LLM/code widgets, sources and sandboxing, builder, charts, and home/dashboard boards.
---
...
- Dashboard localStorage keys (`yaawc_dashboard_*`) are DB-synced — see `yaawc-settings-persistence`.

Related: `yaawc-streaming-events` (`widget_proposal`, widget-builder stream), `yaawc-settings-persistence`, `yaawc-design-system`, `yaawc-prompt-system`.
